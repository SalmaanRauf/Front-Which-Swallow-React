...
Navbar8.defaultProps = {
  ...
  action1: 'Buy Now',
  page4: 'Sign Up/Sign In',
  page3ImageSrc:
    'https://images.unsplash.com/photo-1611605698323-b1e99cfd37ea?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxOTgzNjYyMHw&ixlib=rb-4.0.3&q=80&w=1080',
  action2: 'Sign Up',
  page3Description: 'Details on time blocking benefits and setup',
  link3: '/learn',
  page4Description:
    'Fill form, auto-generate personalized calendar, downloadable PDF option',
  page3ImageAlt: 'Learn Page Image',
  page1Description: "Basic info, call to action ('Buy Now' or 'Sign Up')",
  page4ImageAlt: 'Sign Up/Sign In Page Image',
  page1: 'Home',
  page2ImageAlt: 'About Page Image',
  page4ImageSrc:
    'https://images.unsplash.com/photo-1682686578023-dc680e7a3aeb?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxOTgzNjYyMHw&ixlib=rb-4.0.3&q=80&w=1080',
  logoSrc:
    'https://aheioqhobo.cloudimg.io/v7/_playground-bucket-v2.teleporthq.io_/84ec08e8-34e9-42c7-9445-d2806d156403/fac575ac-7a41-484f-b7ac-875042de11f8?org_if_sml=1&force_format=original',
  page2Description: 'Info about the creator (doctor)',
  page2ImageSrc:
    'https://images.unsplash.com/photo-1540921002383-b2a7ff6a716d?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxOTgzNjYyMHw&ixlib=rb-4.0.3&q=80&w=1080',
  link1: '/home',
  link2: '/about',
  page1ImageSrc:
    'https://images.unsplash.com/photo-1567653418876-5bb0e566e1c2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w5MTMyMXwwfDF8cmFuZG9tfHx8fHx8fHx8MTcxOTgzNjYyMHw&ixlib=rb-4.0.3&q=80&w=1080',
