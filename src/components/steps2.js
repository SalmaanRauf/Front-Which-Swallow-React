...
Steps2.defaultProps = {
  step1Description:
    'Create an account or log in to access the premium time-blocking calendar service.',
  step3Description:
    'Provide your preferences and schedule details to generate a personalized time-blocking calendar.',
  step4Title: 'Auto-generate Calendar',
  step2Title: 'Purchase Service',
  step2Description:
    'Select a subscription plan and make a secure payment to unlock all features.',
  step3Title: 'Fill Form',
  step1Title: 'Sign Up/Sign In',
  step4Description:
    'Once the form is submitted, your custom time-blocking calendar will be automatically created.',
}
